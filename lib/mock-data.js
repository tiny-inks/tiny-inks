...
export const CATEGORIES = [
  { handle: 'notebooks', descEn: 'Thick, fountain-pen-friendly notebooks in every size — for class notes, journals and big ideas.', descAr: 'دفاتر بورق سميك يناسب أقلام الحبر بكل المقاسات — لملاحظات الدراسة واليوميات والأفكار الكبيرة.', key: 'Notebooks', en: 'Notebooks', ar: 'دفاتر', match: ['Notebooks'], color: 'var(--blue)' },
  { handle: 'journals', descEn: 'Guided and blank journals for daily pages, gratitude and everything in between.', descAr: 'يوميات موجهة وفارغة للصفحات اليومية والامتنان وكل ما بينهما.', key: 'Journals', en: 'Journals', ar: 'يوميات', match: ['Journals'], color: 'var(--sage)' },
  { handle: 'planners', descEn: 'Daily, weekly and monthly planners that make ticking things off genuinely satisfying.', descAr: 'مخططات يومية وأسبوعية وشهرية تجعل شطب المهام متعة حقيقية.', key: 'Planners', en: 'Planners', ar: 'مخططات', match: ['Planners'], color: 'var(--cream)' },
  { handle: 'pens-tools', descEn: 'Pens, pencils and desk tools we tested with real ink before putting on the shelf.', descAr: 'أقلام وأدوات مكتبية جربناها بحبر حقيقي قبل وضعها على الرف.', key: 'Pens & Tools', en: 'Pens & Tools', ar: 'أقلام وأدوات', match: ['Pens & Tools'], color: 'var(--mustard)' },
  { handle: 'desk-notes', descEn: 'Sticky notes, pads and organisers that keep desks (and heads) tidy.', descAr: 'ملاحظات لاصقة ومفكرات ومنظمات تُبقي المكاتب — والأذهان — مرتبة.', key: 'Desk & Notes', en: 'Desk & Notes', ar: 'مكتب وملاحظات', match: ['Desk & Notes'], color: 'var(--blush)' },
  { handle: 'gift-sets', descEn: 'Wrapped, carded and ready to hand over — complete gifts with zero assembly.', descAr: 'مغلفة ومع بطاقة وجاهزة للتقديم — هدايا متكاملة دون أي تجهيز.', key: 'Gift Sets', en: 'Gift Sets', ar: 'أطقم الهدايا', match: ['Gift Sets'], color: 'var(--terracotta)' },
];
