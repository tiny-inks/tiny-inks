...
export const ADMIN_DOMAIN = process.env.SHOPIFY_STORE_DOMAIN || process.env.NEXT_PUBLIC_SHOPIFY_STORE_DOMAIN || '';
export const ADMIN_VERSION = process.env.SHOPIFY_ADMIN_API_VERSION || '2026-01';
export const ADMIN_LIVE = Boolean(ADMIN_TOKEN && ADMIN_DOMAIN);
...
export async function adminFetch(query, variables = {}) {
  const r = await fetch(`https://${ADMIN_DOMAIN}/admin/api/${ADMIN_VERSION}/graphql.json`, {
    method: 'POST',
